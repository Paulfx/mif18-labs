...
extern void cpt_O_button_state(void* cdata, _boolean);
#ifdef CKCHECK
extern void cpt_BOT_led_on(void* cdata);
extern void cpt_BOT_button_state(void* cdata);
#endif
/*--------
...
//CODE
   ...
   cpt_O_button_state(ctx->client_data, L8);
   T6 = L1;
   ctx->M6 = T6;
   ctx->M6_nil = _false;
   ctx->M2 = ctx->M2 && !(_true);
